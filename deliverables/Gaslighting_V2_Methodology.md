...
- Confirmed Claude nudges detected: 2,266 (vs 155)
- Extracted candidate Claude utterances: 2,186 (vs 110)
- Transcript-format posts: 40 (vs 2)

### PMI / association on the full corpus

| Disclosure | P(nudge\|lex) | Lift | PMI |
|---|---|---|---|
| Temporal | 13.2% | 5.3x | 2.39 |
| Session | 7.9% | 3.2x | 1.65 |
| Affective | 6.3% | 2.5x | 1.33 |
| Work context | 3.3% | 1.3x | 0.40 |

Rank order matches V2 with tighter spacing. Temporal disclosure is now the
unambiguous top predictor at 5.3x base rate. Work context still fails to
